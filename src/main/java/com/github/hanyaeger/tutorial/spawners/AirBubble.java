...
public class AirBubble extends DynamicCircleEntity implements Collided, SceneBorderCrossingWatcher {
    public AirBubble(int speed, Coordinate2D initialLocation){
        super(initialLocation); //, new Size(50, 50));

        setRadius(5.0);
        //setStrokeWidth(50.0);
        setFill(Color.DARKSEAGREEN); // TRANSPARRENT
        setOpacity(100.0);
